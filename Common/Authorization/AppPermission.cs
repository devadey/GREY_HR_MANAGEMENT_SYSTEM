...
{
    //This static field returns the collection of all the permissions that both the admin and
    //the basic users can perform for all the application features.
    ...
    // Filter for only the admin permissions from the list of permissions created above
